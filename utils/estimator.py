from settings.constants import TRAIN_CSV, SAVED_SCALER
...
class Estimator:
    def __init__(self, train_csv=None, loader=None, scaler=None, model=None):
        ...
        if self.model is None:
            self.model = CatBoostRegressor(iterations=1800,
